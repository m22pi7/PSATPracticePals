...
public class QuestionData
{
	...
	public QuestionData(int difficulty) throws IOException
	{
		...
		if(difficulty == 1)
			questionParse = new BufferedReader(new FileReader("C:\\Users\\Sandra\\eclipse-workspace\\Writing work\\Easy Questions.txt")); //replace with file location
		if(difficulty == 2)
			questionParse = new BufferedReader(new FileReader("C:\\Users\\Sandra\\eclipse-workspace\\Writing work\\Medium Questions.txt")); //replace with file location
		if(difficulty == 3)
			questionParse = new BufferedReader(new FileReader("C:\\Users\\Sandra\\eclipse-workspace\\Writing work\\Hard Questions.txt")); //replace with file location
